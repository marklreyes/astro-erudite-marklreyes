...
- ...write, write, write. Outside of a word document, Markdown allows me to do that task relatively quickly. That said, *writer's block* is still an issue!
...
- ...chuck something else into the sky on Netlify's free tier.
