---
title: 'State of Static Blogs with Foreword by Mark'
...
date: 2025-03-14
tags: ['web-dev', 'opinion', 'personal-log', 'astro', 'netlify']
image: './1200x630_enscribe.png'
authors: ['marklreyes']
---

## Foreword by Mark

The migration of my portfolio from WordPress with WP Engine to Astro with Netlify couldn't have been accomplished without the original work of the author of this template, *enscribe* ([jktrn](https://github.com/jktrn) on GitHub). His original article can be found [here](https://astro-erudite.vercel.app/blog/the-state-of-static-blogs).

I thought it'd be worth keeping his paper trail as this front-end is built on the backbone of some very specific opinions. My headspace when shopping around for a new way to display my blog was to ensure that I could:

- ...write, write, write. Outside of a word document or Notes app, Markdown allows me to do that task relatively quickly. That said, *writer's block* is still an issue!
- ...apply my existing skillset to tinker with the React UI when the mood strikes.
- ...not have to write more code to match a certain aesthetic, trend or theme. Custom blocks, headless CMS, etc. are cool but I just don't have time.
- ...lessen the code bloat sent to the browser out-of-box, divorcing myself of additional plugins or expensive optimization services from dedicated hosting providers. I guess this is about island architecture which lends itself to the next bullet point.
- ...get deeper into the trenches of Astro, its promises of SEO and its proclamation of being *the world's fastest*. I had 182 posts to import from WordPress so this better work!
- ...chuck something else into the sky on Netlify's free tier and close the book on paid hosting.

So far, it's been a good vibe in initially importing the contents of my blog into this brave new world. It's not without its headaches, rest assured. The learning curves are ever present but it's worth the wrench time knowing that I'm aiming for the specifics mentioned above. More to come in due time.
